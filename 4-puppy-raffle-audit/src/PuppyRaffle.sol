...
contract PuppyRaffle is ERC721, Ownable {
    ...
    // @audit-issue DoS with introducing lot address
    ...
    // @audit-issue Does not implement cei pattern Reentrancy!
    ...
    // @audit-issue block.timestamp randomness - winner index predictable
    // @audit-issue why function is extenal and not onlyOwner???
    ...
    function selectWinner() external {
        ...
        console.log("[IC] winnerIndex:", winnerIndex);
        ...
        console.log("[IC] Prize is", prizePool);
        (bool success,) = winner.call{value: prizePool}("");
        require(success, "PuppyRaffle: Failed to send prize pool to winner");
        _safeMint(winner, tokenId);
    }

    // note - not interesting if I can't change feeAddress
    ...
    // note onlyOwner modifier seems to be ok
